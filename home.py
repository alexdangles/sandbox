...
class Ui_Home(object):
    def setupUi(self, Home):
        ...
        self.tab1.setGeometry(QtCore.QRect(0, 0, 591, 391))
        self.tab1.setStyleSheet("background-color: rgb(50, 150, 150);")
...
"background-color: rgb(195, 69, 69);")
        ...
        self.dial1.setGeometry(QtCore.QRect(30, 20, 111, 121))
        ...
        self.label.setGeometry(QtCore.QRect(300, 40, 251, 251))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("d:\\Projects\\Learning\\../../Pictures/Memes/Rock in a pond.jpg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.axWidget = QAxContainer.QAxWidget(self.tabCtl)
        self.axWidget.setProperty("geometry", QtCore.QRect(70, 160, 80, 70))
