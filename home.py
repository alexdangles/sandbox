...
class Ui_Home(object):
    def setupUi(self, Home):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/main/icons/power.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnLED.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/main/icons/target.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnLaser.setIcon(icon2)
        ...
        self.btnWeb.setGeometry(QtCore.QRect(30, 140, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        ...
        self.btnWeb.setStyleSheet("background-color: rgb(255, 0, 0);")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/main/icons/alert round.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon3)
        self.actionAbout.setObjectName("actionAbout")
        self.actionOpen = QtWidgets.QAction(Home)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/main/icons/open folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/main/icons/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon5)
        self.actionSave.setObjectName("actionSave")
        self.actionQuit = QtWidgets.QAction(Home)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/main/icons/quit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
